...
func TestWindowsTrayAPIOmitsSecrets(t *testing.T) {
	...
	blocked := httptest.NewRequest(http.MethodGet, "/api/windows-tray", nil)
	...
	req := httptest.NewRequest(http.MethodGet, "/api/windows-tray", nil)
	req.Host = "127.0.0.1"
